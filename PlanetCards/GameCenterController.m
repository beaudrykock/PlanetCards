...
- (void)actionSheet:(UIActionSheet *)actionSheet didDismissWithButtonIndex:(NSInteger)buttonIndex
{
    switch(buttonIndex)
    {
        case 0:
            ...
            break;
        // UNCOMMENT FOR MORE THAN ONE LEADERBOARD
        /*case 1:
        ...
        case kLeaderBoardSection:
        {
            if(rowNumber == 0)
            {
                UIActionSheet* selectLeaderboard= [[[UIActionSheet alloc] initWithTitle: @"Select Leaderboard" delegate:self cancelButtonTitle: @"Cancel" destructiveButtonTitle: NULL
                                                                      otherButtonTitles: [NSString stringWithFormat: @"%@ Leaderboard", NSLocalizedString(kLeaderboardID, NULL)],
